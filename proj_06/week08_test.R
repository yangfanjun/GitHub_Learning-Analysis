...
week02_code <- all_code %>% filter(week=="Week 08") %>% select(vert1_id,vert2_id)
...
nodes_v1 <- all_code %>% filter(week=="Week 08") %>% select(vert1_id)
nodes_v2 <- all_code %>% filter(week=="Week 08") %>% select(vert2_id)
